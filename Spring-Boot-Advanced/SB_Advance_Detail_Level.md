...
* pom.xml add dependency spring-boot-starter-test adding scope as test becasue it won't deploy with actual code
```xml
	<dependency>
			<groupId>org.springframework.boot</groupId>
...
```
- src/test/java/
* com.jd.springboot.controller.SurveyControllerIT 
```java
package com.jd.springboot.controller;
...
*src/test/java/ com.jd.springboot.controller.SurveyControllerTest
```java
package com.jd.springboot.controller;
...
### Useful Snippets and References
First Snippet
* com.jd.springboot.security.SecurityConfig
```java
package com.jd.springboot.security;
