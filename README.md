...
Github Folder - https://github.com/jdbirla/JD_Spring_Boot_Master/tree/master/Spring-Boot-Advanced
...
Github Folder - https://github.com/jdbirla/JD_Spring_Boot_Master/tree/master/spring-boot-first-web-application
...
auth.inMemoryAuthentication()
            .passwordEncoder(NoOpPasswordEncoder.getInstance())
        		.withUser("jd").password("dummy")
```

Old Code
```
auth.inMemoryAuthentication().withUser("jd").password("dummy")
```
